package nc.opt.refapp.repository;

import nc.opt.refapp.ReferentielApplicationApp;
import nc.opt.refapp.config.Constants;
import nc.opt.refapp.config.audit.AuditEventConverter;
import nc.opt.refapp.domain.PersistentAuditEvent;
...
import static nc.opt.refapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
